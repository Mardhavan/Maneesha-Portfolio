      ...
      <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-2 gap-8 md:gap-16 items-center relative z-10">
        ...
        <div className="order-1 md:order-2 flex justify-center animate-fade-in">
          <div className="relative">
            {/* Multi-layer glowing halo behind */}
            ...
            <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-primary/20 via-purple-500/20 to-accent/20 blur-2xl scale-110 animate-pulse-glow" style={{ animationDelay: "1s" }} />
